...
string_table
	...
	DB 0 ; null terminator
	DB 130
	DB "THIS IS THE GROUND FLOOR OF HERRICK'S DEPARTMENT STORE.  WIDES STAIRCASES LEAD UP AND DOWN. CLASS DOORS LEAD OUTSIDE TO THE SOUTH." ; 10
	DB 0 ; null terminator
	DB 94
	...
	DB 0 ; null terminator
	DB 31
	DB "THE LIFT SLOWLY DESCENDS FLOOR." ; 68
	DB 0 ; null terminator
	DB 42
